// 站点全局配置
export const SITE_TITLE = '干货·工程化复盘';
export const SITE_DESCRIPTION =
	'Java 后端生产事故复盘与工程化实战。申延彬 · 开源 Solo Workspace / solo-spring-scaffold';
export const SITE_AUTHOR = '申延彬';
export const GITHUB_URL = 'https://github.com/shenyb';
export const WORKSPACE_GITHUB_URL = 'https://github.com/shenyb/solo-workspace';
